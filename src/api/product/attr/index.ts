...
export const reqCategory02 = (id1: number | string) => request.get<any, CategoryResponse>(API.CATEGORY02_URL + id1);
export const reqCategory03 = (id2: number | string) => request.get<any, CategoryResponse>(API.CATEGORY03_URL + id2);
export const reqAttr = (id1: number | string, id2: number | string, id3: number | string) => request.get<any, AttrResponse>(API.ATTR_URL + `${id1}/${id2}/${id3}`);
