...
<template>
  <div>
    ...
    <el-dialog
      ...
      :title="newBrandInfo.id ? '修改品牌' : '添加品牌'"
      style="padding: 30px"
      @close="clearEverything"
    >
      <el-form :rules ref="formRef" style="width: 80%" :model="newBrandInfo">
        ...
        <el-form-item label="上传LOGO" label-width="100px" prop="logoUrl">
          ...
          >
            <img
              v-if="newBrandInfo.logoUrl"
              :src="newBrandInfo.logoUrl"
              class="avatar"
            />
      ...
      <template #footer>
        <el-button type="primary" @click="confirm" size="default"
          >确认</el-button
        >
        <el-button type="default" @click="cancel" size="default"
          >取消</el-button
        >
      </template>
    </el-dialog>
